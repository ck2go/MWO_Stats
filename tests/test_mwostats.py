...
class TestMatch:
    ...
    def setup_class(self):
        match1_filename = 'resources/test1.jpg'
        self.match1 = Match(match1_filename)
        self.match1.getStats()
    ...
    def test_match1getStatsReturnsDf(self):
        assert type(self.match1.getStats()) == pd.DataFrame
